...
app_title <- "Test NetSuite Dashboard"
app_version <- "version 1.0.0"
data_last_day <- "2020-05-10" %>% as.Date()
data_first_day <- "2015-01-01" %>% as.Date()
marketplace_website <- "https://www.netsuite.com/portal/products/analytics.shtml"
...
appsilonLogo <- HTML("
  <svg class='logo-svg' viewBox='0 0 660.52 262.96'>
    <use href='assets/icons/oracle-netsuite-logo.svg'></use>
  </svg>
")
